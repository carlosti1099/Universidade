...
VALUES
('Ultramedical','Rua Gandu','São Paulo','SP',11996692027,'gmail@gmail.com'),
('Cassems','Av Otaviano dos santos','Iguatemi','MS','67989998867','suporte@hotmail.com'),
('Unimed','Rua Praça Joaquim','Belo Horizonte','MG',04133164340,'info@yahoo.com');
GO
...
--nao repete informações, quais preços existem:
...
as select
p.CodProjeto as [Código do Projeto],
p.DateStart as [Data de Início],
...
as select
cp.CodConsultorProjeto as [Código Projetos-Consultor],
cp.CodProjeto as [Código Projetos],
c.NameConsultor as [Nome do Consultor],
cp.HoursWorked as [Horas Trabalhadas],
cp.FunctionPerformed as [Função Exercida]
